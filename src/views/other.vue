  ...
  <div class="screen">
    ...
    <div class="position">
      <div class="position_left">
        <h2><strong>Datos del paciente mascotudo </strong></h2>
        <p></p>
        ...
        <div class="position_right">
          ...
          <!-- Aqui debe ir el codigo para mostrar las citas que hay en mongodb-->
          <!--
          <div class="datos" v-for="formulario in cita" :key="formulario">
          {{formulario}}
          </div>
          -->
          <v-data-table
